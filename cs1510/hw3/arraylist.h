...
public:
  ...
  // Purpose: resizes the list
  // Parameters: s : the new size requested 
  //             x : a value to initialize
  // Postconditions: if s < m_size, the list is trimmed to the new size s.
  //                 if s == m_size, the list is unchanged
  //                 if s > m_size, the list grows to size s and the new 
  //                    elements are all copies of x 
  void resize(int s, const T& x);
